...
export default function Home() {
  return (
    <div className="min-h-screen selection:bg-purple-500/30">
      ...
      {/* Hero */}
      <section className="relative min-h-screen flex flex-col justify-center items-center px-6 pt-40 pb-20 overflow-hidden">
        {/* Decorative elements */}
        <div className="absolute top-1/4 -left-20 w-96 h-96 bg-purple-600/20 rounded-full blur-[100px] pointer-events-none" />
        <div className="absolute bottom-1/4 -right-20 w-96 h-96 bg-blue-600/20 rounded-full blur-[100px] pointer-events-none" />
        ...
        <div className="max-w-6xl mx-auto w-full z-10">
          ...
          >
            <motion.div 
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-purple-500/30 bg-purple-500/10 text-purple-300 text-sm font-medium mb-10 hover:bg-purple-500/20 transition-colors cursor-default"
            >
              <Brain className="w-4 h-4" />
              <span>Next-Gen AI Recruiting Pipeline</span>
            </motion.div>

            <h1 className="text-5xl md:text-8xl font-bold mb-10 leading-[1.1] tracking-tight">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Link
                href="/pipeline"
                className="group relative inline-flex items-center gap-3 px-10 py-5 bg-gradient-to-r from-purple-600 to-blue-600 rounded-full text-lg font-semibold text-white shadow-xl shadow-purple-600/20 hover:shadow-purple-600/40 hover:scale-105 transition-all duration-300 overflow-hidden"
              >
          ...
          <div className="mt-24 md:mt-32">
            ...
            >
              ...
              <div className="relative flex flex-wrap justify-center items-center gap-10 md:gap-14">
                {[
                  ...
                  <div key={step.label} className="flex items-center gap-4 md:gap-8 group">
                    <motion.div
                      ...
                      className="relative"
                    >
                      <div className={`w-22 h-22 md:w-28 md:h-28 rounded-2xl bg-gradient-to-br ${step.color} flex flex-col items-center justify-center gap-2.5 shadow-lg z-10 relative group-hover:translate-y-[-5px] transition-transform duration-300`}
                      >
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          {stats.map((stat, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              variants={fadeUp}
              className="glass-card p-10 text-center hover:bg-white/[0.04] transition-colors group"
            >
              <div className="w-14 h-14 mx-auto mb-6 rounded-full bg-white/5 flex items-center justify-center group-hover:scale-110 transition-transform duration-500">
      ...
      {/* Features */}
      <section className="py-32 px-6 bg-[var(--bg-secondary)] relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((f, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                variants={fadeUp}
                className="glass-card-solid p-10 group hover:-translate-y-2 transition-transform duration-300"
              >
                <div
                ...
                <h3 className="text-2xl font-semibold mb-5 text-white group-hover:text-purple-300 transition-colors">
                  {f.title}
                </h3>
                ...
                <div className="mt-8 pt-8 border-t border-[var(--border)] flex items-center text-sm font-medium text-[var(--text-muted)] group-hover:text-white transition-colors">
      ...
      <section className="py-32 px-6 relative overflow-hidden">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="max-w-4xl mx-auto text-center glass-card p-16 md:p-20 relative overflow-hidden border-t border-white/10"
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-[var(--text-secondary)] mb-10 text-xl max-w-2xl mx-auto">
              Join thousands of recruiters using AI to save hours every single day.
            </p>
            <Link
              href="/pipeline"
              className="inline-flex items-center gap-3 px-12 py-5 bg-white text-black rounded-full text-lg font-bold hover:bg-gray-100 transition-all shadow-xl hover:shadow-2xl hover:scale-105"
            >
      ...
      {/* Footer */}
      <footer className="py-12 px-6 border-t border-[var(--border)] bg-[var(--bg-secondary)]">
